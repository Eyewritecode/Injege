This project aims at Analyzing data from Rwandan major news websites.
...
This is part --indeed the first step-- of my "Upload Kinyarwanda"(UpKin) initiative. As a long term objective, I want to collect a large corpora of Kinyarwanda text that can be used by researchers and developers to make implementation of modern NLP algorithms on the Kinyarwanda language. 
...
<b>Development philosophy of UpKin
